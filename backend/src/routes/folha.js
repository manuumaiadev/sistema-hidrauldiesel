...
const { gerarFolhaDia05, gerarFolhaDia20, buscarFolha, atualizarLancamento, listarFolhas, excluirFolha, adicionarFuncionarioFolha, removerLancamento, resumoMensalFolha } = require('../controllers/folhaController');

router.get('/resumo-mensal',                   auth, resumoMensalFolha);
